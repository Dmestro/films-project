...
<head>
    ...
    <script src="js/create_film.js"></script>
...
<div class="container" style="margin-top: 100px">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="col-md-12 add-prop-panel-outer">
            <div class="col-md-3">
                <button type="button" class="btn btn-primary add-prop-btn" id="add-producers-button" data-toggle="modal" data-target="#modal-producers">Добавить режиссеров</button>
            </div>
            <div class="col-md-9 add-prop-panel">
                <div class="panel panel-default add-prop-panel">
        ...
        <div class="col-md-12 add-prop-panel-outer">
            <div class="col-md-3">
                <button type="button" class="btn btn-primary add-prop-btn" id="add-genres-button" data-toggle="modal" data-target="#modal-genres">Добавить Жанры</button>
            </div>
            <div class="col-md-9 add-prop-panel" >
                <div class="panel panel-default add-prop-panel">
        ...
        <div class="col-md-12 add-prop-panel-outer">
            <div class="col-md-3">
                <button type="button" class="btn btn-primary add-prop-btn" id="add-countries-button" data-toggle="modal" data-target="#modal-countries">Добавить страны</button>
            </div>
            <div class="col-md-9 add-prop-panel">
                <div class="panel panel-default add-prop-panel">
    ...
    <div class="col-md-12" style="margin-top: 20px; margin-bottom:40px;">
        <div class="col-md-6 col-md-offset-3">
            <button type="button" class="btn btn-success" id="add-film-button">Добавить</button>
